...
import os
import argparse
from opt_eot import attack_targeted
...
def compute_transform_robustness(img, delta, mask, model, xforms, xforms_pt_file, model_input_size, target_label, lbd = 1.0):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', type=str, default='../logs/l0_and_opt_eot')
